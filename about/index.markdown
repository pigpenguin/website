...
About the site
--------------
This site is built using [jekyll](http://jekyllrb.com/). The theme is [solar](https://github.com/redwallhp/solar-theme-jekyll) that has been slightly altered and is using the digital love colour scheme by phyrne of [unixhub](http://unixhub.net). The source code can be found [here](http://www.github.com/pigpenguin/website).
